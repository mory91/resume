...
\name{Seyed Morteza}{Hosseini}
\mobile{(+1) 403 464 0795}

\email{seyedmorteza.hossein@ucalgary.ca}
\github{mory91}
%\skype{skypeid}
...
\position{Software Engineer{\enskip\cdotp\enskip}Researcher} % Your expertise/fields

\makecvfooter{}{Seyed Morteza Hosseini~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
% \input{cv-sections/research_intersts.tex}
